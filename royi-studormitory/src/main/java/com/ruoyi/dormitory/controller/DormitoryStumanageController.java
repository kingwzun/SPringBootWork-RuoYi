 ...
 */
@Controller
@RequestMapping("/studormitory/stumanage")
public class DormitoryStumanageController extends BaseController
{
    private String prefix = "studormitory/stumanage";

    @Autowired
    private IDormitoryStumanageService dormitoryStumanageService;

    @RequiresPermissions("studormitory:stumanage:view")
    @GetMapping()
     ...
     * 查询住宿生信息列表
     */
    @RequiresPermissions("studormitory:stumanage:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出住宿生信息列表
     */
    @RequiresPermissions("studormitory:stumanage:export")
     ...
     * 新增保存住宿生信息
     */
    @RequiresPermissions("studormitory:stumanage:add")
     ...
     * 修改住宿生信息
     */
    @RequiresPermissions("studormitory:stumanage:edit")
    @GetMapping("/edit/{sid}")
     ...
     * 删除住宿生信息
     */
    @RequiresPermissions("studormitory:stumanage:remove")
